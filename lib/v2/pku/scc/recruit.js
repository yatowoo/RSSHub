...
let numEntry = 20; // DEBUG
const maxDetails = 50; // DEBUG
module.exports = async (ctx) => {
    ...
    let sorted = list.sort((a, b) => b.pubDate.getTime() - a.pubDate.getTime());
    if (numEntry > 0) {
        sorted = sorted.slice(0, numEntry);
    } else {
        numEntry = sorted.length;
    }
