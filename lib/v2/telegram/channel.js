        ...
        item:
            ...
            list
                .map((index, item) => {
                    ...
                    /* inline buttons */
                    let inlineButtons = '';
                    const inlineButtonNodes = item.find('.tgme_widget_message_inline_button');
                    if (showInlineButtons && inlineButtonNodes.length) {
                        ...
                        inlineButtonNodes.each((_, button) => {
                            ...
                            inlineButtons += `<td style="border: 2px solid;text-align: center"><a href="${buttonUrl}"><b>${buttonText}</b></a></td>`;
                        });
